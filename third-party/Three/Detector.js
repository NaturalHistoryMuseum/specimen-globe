      ...
      if(window.WebGLRenderingContext){
        ...
        if(navigator.userAgent.toLowerCase().indexOf('safari/') > -1){
          domElement.innerHTML = [
            'Sorry, your browser doesn\'t currently support WebGL. If you\'re using Safari please <a href="https://discussions.apple.com/thread/3300585?start=0&tstart=0">enable WebGL</a>.'
          ].join( '\n' );
        }else{
          domElement.innerHTML = [
